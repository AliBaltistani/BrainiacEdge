<?php $this->view('students/student-header',$data) ?>
	...
	<div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?=ROOT.'/student/enrolled-courses'?>">Home</a></li>
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <div class="social-links mt-2">
                <a href="<?=$row->twitter_link?>" class="twitter"><i class="bi bi-twitter"></i></a>
                <a href="<?=$row->facebook_link?>" class="facebook"><i class="bi bi-facebook"></i></a>
                <a href="<?=$row->instagram_link?>" class="instagram"><i class="bi bi-instagram"></i></a>
                <a href="<?=$row->linkedin_link?>" class="linkedin"><i class="bi bi-linkedin"></i></a>
              </div>
            </div>
          </div>
                  ...
                  <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <div class="d-flex">
                          <img class="js-image-preview" src="<?=get_image($row->image)?>" alt="Profile" style="width:200px;max-width:200px;height:200px;object-fit: cover;">
                  ...
                  <form method="post">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <small class="js-error-currentpassword text-danger"><?=$errors['currentpassword']?></small>
                      <?php endif;?>
                      <small class="js-error-currentpassword text-danger"></small>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <small class="js-error-password text-danger"><?=$errors['password']?></small>
                      <?php endif;?>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <small class="js-error-retype_password text-danger"><?=$errors['retype_password']?></small>
                      <?php endif;?>
                      <small class="js-error-retype_password text-danger"></small>
                      </div>
                    </div>

                    <div class="text-center">
                    <input name="action" type="hidden" class="form-control" id="change-password" value="change-password">
                      <button onclick="change_password(event)" type="button" class="btn btn-primary">Change Password</button>
