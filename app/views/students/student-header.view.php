...
<body>
      ...
      <ul class="d-flex align-items-center">
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?=ROOT?>/students/profile">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?=ROOT?>/students/enrolled-courses">
      ...
      <?php if(user_can('view_cart_items')):?>
      <li class="nav-item">
        <a class="nav-link " href="<?=ROOT?>/students/my-carts">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?=ROOT?>/students/profile">
          <i class="bi bi-person"></i>
          <span>My Profile</span>
        </a>
      </li><!-- End Dashboard Nav -->
