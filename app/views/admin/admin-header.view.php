...
<body>
      ...
      <ul class="d-flex align-items-center">
        <li class="nav-item dropdown pe-3">
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="<?=get_image(Auth::getImage())?>" alt="Profile" class="rounded-circle">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <?php if(user_can('view_courses')):?>
      <li class="nav-item">
        <a class="nav-link " href="<?=ROOT?>/admin/courses">
          <i class="bi bi-camera-reels"></i>
          <span><?= (Auth::is_admin())?'All Courses': 'My Courses' ?></span>
        </a>
      </li><!-- End Dashboard Nav -->
      <?php endif;?>
      ...
      <?php if(user_can('view_categories')):?>
        <li class="nav-item">
          <a class="nav-link " href="<?=ROOT?>/admin/pricies">
            <i class="bi bi-prices">RM</i>
            <span>Prices Managment</span>
          </a>
        </li><!-- End Dashboard Nav -->
      <?php endif;?>
      ...
      <?php if(user_can('view_roles')):?>
       ...
       <li class="nav-item">
        <a class="nav-link " href="<?=ROOT?>/admin/competitions">
          <i class="bi bi-books">Cp</i>
      ...
      <?php if(user_can('view_enrolled_courses')):?>
      <li class="nav-item">
        <a class="nav-link " href="<?=ROOT?>/admin/lessons">
          <i class="bi bi-person-video3"></i>
          <span>Enrollment Managment</span>
        </a>
      </li><!-- End Dashboard Nav -->
      <?php endif;?>

      <li class="nav-item">
        <a class="nav-link " href="<?=ROOT?>/admin/all-students">
        <i class="bi bi-people"></i>
