            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form method="post" action="<?=ROOT?>/Signup/sent_otp" class="row g-3 needs-validation" novalidate>

                    <div class="col-12">
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">Email</span>
                        <input value="<?= set_value('email')?>" type="text" name="email" class="form-control" id="yourUsername" placeholder="enter your email" required1>
                        <div class="invalid-feedback">Please enter your email.</div>

                      </div>
                   </div>
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit">Verify now</button>
                    </div>
                    <div class="col-12">
