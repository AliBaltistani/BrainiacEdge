            ...
            <div class="col-lg-4 mb-lg-0 mb-3">
                <div class="card p-3">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <small><span class="fw-bold">Expiry date:</span><span><?=get_date($rows->date)?></span></small>
                        <small><span class="fw-bold">Name:</span><span><?=$rows->user_row->name?></span></small>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-lg-0 mb-3">
                <div class="card p-3">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <small><span class="fw-bold">Expiry date:</span><span><?=get_date($rows->date)?></span></small>
                        <small><span class="fw-bold">Name:</span><span><?=esc($rows->user_row->name)?></span></small>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-lg-0 mb-3">
                        ...
                        <div class="collapse p-3 pt-0" id="collapseExample">
                            <div class="row">
                                <div class="col-8">
                                    ...
                                    <p class="mb-0"><span class="fw-bold">Product:</span><span class="c-green">: <?=esc($rows->title)?></span></p>
                                    <p class="mb-0"><span class="fw-bold">Price:</span><span
                                            class="c-green">: <?=esc($rows->price_row->name) ?></span></p>
                                    <p class="mb-0"><?=esc($rows->price_row->description) ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
