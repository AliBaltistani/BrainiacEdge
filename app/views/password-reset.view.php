                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">Create a strong password, Strong password consist of Numbers, latter, special characters</p>
                                    </div>
                                    ...
                                    <?php if (!empty($success['email'])) : ?>
                                        <div class="alert alert-success text-center"><?= $success['email'] ?></div>
                                    <?php endif; ?>


                                    <form method="post" action="<?= ROOT ?>/forget_password/password_update" class="row g-3 needs-validation" novalidate>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input value="<?= set_value('password') ?>" type="password" name="retype_password" class="form-control" id="retype_password" required1>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input value="<?= $user_id ?>" type="hidden" name="user_id" class="form-control" id="user_id" required1>
