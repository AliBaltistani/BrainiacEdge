...
<head>
  ...
  <title><?=(!empty($title))?$title:''?> - <?=APP_NAME?></title>
...
<body>
      ...
      <ul class="d-flex align-items-center">
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?=ROOT.'/instructors/profile'?>">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?=ROOT?>/instructors/dashboard">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?=ROOT?>/instructors/my-courses">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?=ROOT?>/instructors/profile">
          <i class="bi bi-person"></i>
          <span>Profile</span>
        </a>
      </li><!-- End Dashboard Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?=ROOT?>/instructors/my-students">
          <i class="bi bi-person"></i>
