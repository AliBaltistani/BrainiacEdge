    ...
    <div class="card-body">
      ...
      <form method="post" class="row g-3">
        ...
        <div class="text-center">
          ...
          <a href="<?= ROOT ?>/instructors/my-courses">
...
<?php else : ?>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">
        <?= 'My Courses'; ?>
        <a href="<?= ROOT ?>/instructors/my-courses/add">
          ...
          <tbody>
            ...
            <?php foreach ($rows as $row) : ?>
              <tr>
                ...
                <td> 
                <?php if($row->approved == '1') { echo 'approved'; }else{ echo 'pending';}  ?>
                </td >
                <td> 
                ...
                <td>
                  <a href="<?= ROOT ?>/instructors/my-courses/edit/<?= $row->id ?>">
                    <i class="bi bi-pencil-square"></i>
                  </a>
                  <a href="<?= ROOT ?>/instructors/my-courses/delete/<?= $row->id ?>">
